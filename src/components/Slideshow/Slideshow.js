...
const Slideshow = () => {
  ...
  return (
    <div className="flex h-screen w-screen flex-col justify-between overflow-y-hidden backgroundimage">
      <div className="flex relative w-full h-10">
        <img
          src={startjourneyp2}
          alt=""
          className="ml-auto w-28 h-52 "
        />
      </div>
      ...
      <div className="flex relative w-full">
        <img
          src={bgCorner1}
          alt=""
          className="w-28 rotate-90 mr-auto"
        />
      </div>
    </div>
  );
